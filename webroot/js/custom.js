...
$(document).ready(function() {	
	...
	{
        case 'videotimehn.com':
                          var rootFolder = '/devbuild/'; break;
        case 'localhost' :
                          var rootFolder = '/VideoTime/'; break;
	...
	$.vegas('slideshow', {
		delay:5000,
		backgrounds:[
			{ src:rootFolder + 'img/background-1.jpg', fade:1500 },
			{ src:rootFolder + 'img/background-2.jpg', fade:1500 },
			{ src:rootFolder + 'img/background-3.jpg', fade:1500 },
			{ src:rootFolder + 'img/background-4.jpg', fade:1500 },
			{ src:rootFolder + 'img/background-5.jpg', fade:1500 },
	  	]
	})('overlay', {src:rootFolder + 'img/overlay.png'});
